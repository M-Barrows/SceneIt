#pragma checksum "M:\Libraries\GitHub\TVTracker\Pages\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7dade08364ee39057b9b63acae8c9a31396491a2"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7dade08364ee39057b9b63acae8c9a31396491a2", @"/Pages/Index.cshtml")]
...
#line hidden
    ...
    function buildWatchList(TVPrograms) {
        $(""#watchlist"").empty();
        $.each(tvprogram, function (index, item) {
            $(""#watchlist"").append('<li>' + item.title + "" || S."" + item.season + "" e."" + item.episode + '</li>')
        });
    }
